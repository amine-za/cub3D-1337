...
/*   Updated: 2023/09/01 19:31:02 by azaghlou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				draw_lineDDA(mlx_image_t *img, t_vector3color p1,
						t_vector3color p2);
...
void				draw_circle(t_game *game, t_vector2i center, int r,
						int clr);
void				draw_rays(t_game *game, t_vector2f ray);
void				draw_cube(mlx_image_t *img, t_vector2i start,
						t_vector2i end, int color);
void				draw_line(mlx_image_t *img, t_vector2f p0, t_vector2f p1,
						int clr);
void				draw_texture(t_game *game, t_ray ray, t_vector2i a);
void				player_to_image(t_game *game, t_vector2i img_pos, float sx,
						float sy);
